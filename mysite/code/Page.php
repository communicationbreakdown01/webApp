...
class Page_Controller extends ContentController {
	...
	public function init() {
		...
		Requirements::javascript($this->ThemeDir()."/js/jquery.scrollTo.min.js");
		Requirements::javascript($this->ThemeDir()."/js/jquery.ui.touch-punch.min.js");
		Requirements::javascript($this->ThemeDir()."/js/jquery.nicescroll.js");
		Requirements::javascript($this->ThemeDir()."/js/common-scripts.js");
	}
